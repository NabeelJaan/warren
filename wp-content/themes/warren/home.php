...
<div class="grid grid-cols-8 xl:grid-cols-12">
    <div class="-z-10 bg-black col-span-1 col-end-13 row-start-1 aspect-1"></div>
    <div class="-z-10 bg-black hidden xl:block col-span-1 row-start-2 aspect-1"></div>
    <div class="-z-10 bg-black col-span-1 col-start-2 row-start-3 aspect-1"></div>
    <div class="bg-black -z-10 hidden xl:block col-span-2 col-end-10 row-start-3 aspect-2"></div>
    <div class="-z-10 bg-black hidden xl:block col-span-1 col-end-10 row-start-2 aspect-1"></div>
    <div class="-z-10 bg-black relative col-span-2 row-start-4 aspect-2">
        <div class="absolute right-full h-full w-sitePaddingMobileFull bg-black"></div>
    </div>
    <div class="-z-10 bg-black hidden xl:block relative col-span-8 col-end-13 row-start-4 aspect-8">
        <div class="absolute left-full h-full w-sitePaddingMobileFull bg-black"></div>
    </div>
</div>
        ...
        <div class="col-span-12 xl:col-span-10 xl:col-start-2">
            ...
            <div class="acc-container">        
                ...
                <div class="acc border-b border-white">
                    ...
                    <div class="acc-content">
                        <p class="text-white text-2xl font-medium font-anekLatin pb-6 px-3">Lorem ipsum, dolor sit amet consectetur adipisicing elit. doloremque fugiat consectetur beatae quis illo accusamus vero odit, architecto et.</p>
                    </div>
                </div>
