  ...
  <div class="mx-auto max-w-1140px 2xl:max-w-1585px">
      <div class="fc-wrapper md:flex md:justify-between md:items-center">
        <div class="copy-right">
          <p class="text-black text-lg font-anekLatin font-medium">©2022 <span class="text-orangeCrayola font-bold">Warren</span> - All Rights Reserved</p>
        </div>

        <div class="social-link flex items-center gap-4">

          <div>
            <p class="text-black text-lg font-anekLatin font-medium">Follow us:</p>
          </div>

          <div class="bg-black w-[40px] h-[40px] inline-flex items-center justify-center rounded-full hover:bg-orangeCrayola">
            <a href="#">
